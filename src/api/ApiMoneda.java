...
public class ApiMoneda {
    ...
    private static final String API_URL = "https://v6.exchangerate-api.com/v6/45ee2bc7335bddbf89323dd2/latest/";
    ...
    public Moneda obtenerTasas(String codigoBase) throws IOException, InterruptedException {
        ...
        if (response.statusCode() != 200) {
            throw new IOException("Error al intentar conexion con la API: " + response.statusCode());
        }
