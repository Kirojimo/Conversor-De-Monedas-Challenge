package gui;
import servicio.ConversorServicio;
import javax.swing.*;
import java.awt.*;
...
public class VentanaPrincipal extends JFrame {
    ...
    public VentanaPrincipal() {
        setTitle("Conversor de Monedas/Divisas ");
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setSize(600, 450);
        setLocationRelativeTo(null);
        setLayout(new GridBagLayout());
        getContentPane().setBackground(new Color(100, 50, 55));

        GridBagConstraints gbc = new GridBagConstraints();
        gbc.insets = new Insets(10, 10, 10, 10);
        gbc.fill = GridBagConstraints.HORIZONTAL;

        JLabel lblTitulo = new JLabel(" Conversor de Monedas/Divisas", SwingConstants.CENTER);
        ...
        comboDesde.setRenderer(new PaisesNombres(monedas));
        comboHacia.setRenderer(new PaisesNombres(monedas));
        ...
        JButton btnConvertir = new JButton("Convertir Moneda/Peso");
